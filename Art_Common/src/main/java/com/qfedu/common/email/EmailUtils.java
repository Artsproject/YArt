package com.qfedu.common.email;
...
public class EmailUtils {
	...
	private static MimeMessage createMsg(Session session, String myAccount, EmailMsg msg) {
		...
		try {
			//3.1发送方
			message.setFrom(new InternetAddress(myAccount, "艺网", "utf-8"));
			//3.2设置接收方
			/*
			 ...
			 * */
			message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(msg.getEmail(), "艺网", "utf-8"));
			//3.3 设置主题
